! function(a) {
        ...
        return c.each(function(c, d) {
            function e() {
                ...
                C = a('<div class="ge-addRowGroup btn-group" />').appendTo(b), a.each(E.new_row_layouts, function(b, c) {
                    var d = a('<a class="btn-sm btn-grid btn-square btn-grid p-10" />').attr("title", "افزودن سطر " + c.join("-")).on("click", function() {
                        var a = r().appendTo(A);
                        c.forEach(function(b) {
                            s(b).appendTo(a)
                        }), f()
                    }).appendTo(C);
                    d.append('<span class="fa fa-plus-circle"></span><span class="iran-yekan-font"> ' +c.join("-")+'</span> &nbsp;&nbsp;');
                    var e = (c.join(" - "), '<div class="row ge-row-icon">');
                    c.forEach(function(a) {
                        e += '<div class="column col-' + a + '"/>'
                    }), e += "</div>",  d.append(e)
                });
                var e = a('<div class="btn-group float-end float-xl-end"/>').appendTo(b),
                    h = a('<button title="ویرایش سورس کد" type="button" class="btn-code gm-edit-mode"><span class="fa fa-chevron-right"></span><span class="fa fa-chevron-left"></span></button>').on("click", function() {
            ...
            function h() {
                A.find(".row").each(function() {
                    ...
                    if (!b.find("> .ge-tools-drawer").length) {
                        ...
                        j(c, "جابه جایی", "ge-move", "fa-arrows"), j(c, "تنظیمات", "", "fa-cog", function() {
                            d.toggle()
                        }), E.row_tools.forEach(function(a) {
                            j(c, a.title || "", a.className || "", a.iconClass || "fa-wrench", a.on)
                        }), j(c, "حذف سطر", "", "fa-trash", function() {
                            window.confirm("ردیف حذف شود؟") && b.slideUp(function() {
                                b.remove()
                            })
            ...
            function i() {
                A.find(".column").each(function() {
                    ...
                    if (!b.find("> .ge-tools-drawer").length) {
                        var c = a('<div class="ge-tools-drawer" />').prependTo(b);
                        j(c, "جابه جایی", "ge-move", "fa-arrows"), j(c, "ستون را باریکتر کنید (Shift را نگه دارید)", "ge-decrease-col-width", "fa-minus", function(a) {
                            var c = E.valid_col_sizes,
                                d = F[G],
                                e = c.indexOf(m(b, d)),
                                f = c[z(e - 1, 0, c.length - 1)];
                            a.shiftKey && (f = c[0]), o(b, d, Math.max(f, 1))
                        }), j(c, "ستون را گسترده تر کنید (Shift را نگه دارید)", "ge-increase-col-width", "fa-plus", function(a) {
                            var c = E.valid_col_sizes,
                                d = F[G],
                                e = c.indexOf(m(b, d)),
                        ...
                        }), j(c, "افزودن سطر", "ge-add-row", "fa-plus-circle", function() {
                            var a = r();
            ...
            function k(b, c) {
                ...
                a('<input class="ge-id" />').attr("placeholder", "id").val(b.attr("id")).attr("title", "یک شناسه منحصر به فرد تنظیم کنید").appendTo(d).change(function() {
    ...
    function() {
        $.fn.gridEditor.RTEs.ckeditor = {
            init: function(a, b) {
                window.CKEDITOR || console.error("CKEditor در دسترس نیست! مطمئن شوید که ckeditor و فایل‌های js adapter jquery را بارگیری کرده‌اید.");
                var c = this;
                b.each(function() {
                    var b = $(this);
    ...
    function() {
        $.fn.gridEditor.RTEs.summernote = {
            init: function(a, b) {
                jQuery().summernote || console.error("Summernote در دسترس نیست! مطمئن شوید که فایل Summernote js را بارگذاری کرده اید.");
                var c = this;
                b.each(function() {
                    var b = $(this);
                    if (!b.hasClass("active")) {
            ...
            initialContent: "<p>لورم ایپسوم دولور</p>"
        }
    }(),
    function() {
        $.fn.gridEditor.RTEs.tinymce = {
            init: function(a, b) {
                window.tinymce || console.error("tinyMCE در دسترس نیست! مطمئن شوید که فایل tinyMCE js را بارگذاری کرده اید."), b.tinymce || console.error("tinyMCE jquery integration not available! Make sure you loaded the jquery integration plugin.");
                var c = this;
                b.each(function() {
                    var b = $(this);
                    if (!b.hasClass("active")) {
