...
var options2 = {
    ...
    xaxis: {
        categories: ['کره جنوبی', 'کانادا', 'انگلیس', 'هلند', 'ایتالیا', 'فرانسه', 'ژاپن', 'آمریکا', 'چین', 'آلمان'],
    },
    colors:[vihoAdminConfig.primary]
}
...
var options6 = {
    ...
    title: {
        text: 'نمودار خطی با حاشیه نویسی',
        align: 'right'
    },
    labels: series.monthDataSeries1.dates,
    xaxis: {
