...
(function (e, t) {
        ...
        if (ut.acceptData(e)) {
            ...
            if ((c && l[c] && (i || l[c].data)) || !a || r !== t)
                return (
                    ...
                    ("object" == typeof n || "function" == typeof n) && (i ? (l[c] = ut.extend(l[c], n)) : (l[c].data = ut.extend(l[c].data, n))),
                    (s = l[c]),
    ...
    function y(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            "script" === n && t.text !== e.text
                ? ((d(t).text = e.text), v(t))
                : "object" === n
                ? (t.parentNode && (t.outerHTML = e.outerHTML), ut.support.html5Clone && e.innerHTML && !ut.trim(t.innerHTML) && (t.innerHTML = e.innerHTML))
        ...
        for (var n, r = [], i = 0, s = e.length; s > i; i++)
            (n = e[i]),
                n.style &&
                    ...
                    t ? (r[i] || "none" !== n.style.display || (n.style.display = ""), "" === n.style.display && S(n) && (r[i] = ut._data(n, "olddisplay", k(n.nodeName)))) : r[i] || S(n) || ut._data(n, "olddisplay", ut.css(n, "display")));
    ...
    function N(e, t, n, r, i) {
        for (var s = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, o = 0; 4 > s; s += 2)
            "margin" === n && (o += ut.css(e, n + Sn[s], !0, i)),
                r
                    ? ("content" === n && (o -= ut.css(e, "padding" + Sn[s], !0, i)), "margin" !== n && (o -= ut.css(e, "border" + Sn[s] + "Width", !0, i)))
                    : ((o += ut.css(e, "padding" + Sn[s], !0, i)), "padding" !== n && (o += ut.css(e, "border" + Sn[s] + "Width", !0, i)));
        return o;
    }
    ...
    function k(e) {
        ...
        return (
            n ||
                ((n = L(e, t)),
                ("none" !== n && n) ||
                    ((ln = (ln || ut("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(t.documentElement)),
    ...
    function R(e, t, n) {
        ...
        n.queue ||
            ...
            1 === e.nodeType &&
                ...
                "inline" === ut.css(e, "display") && "none" === ut.css(e, "float") && (ut.support.inlineBlockNeedsLayout && "inline" !== k(e.nodeName) ? (p.zoom = 1) : (p.display = "inline-block"))),
            n.overflow &&
                ((p.overflow = "hidden"),
                ...
                if (null != (e = arguments[a]))
                    for (n in e)
                        (r = u[n]),
                            (i = e[n]),
                            u !== i &&
                                (l && i && (ut.isPlainObject(i) || (s = ut.isArray(i))) ? (s ? ((s = !1), (o = r && ut.isArray(r) ? r : [])) : (o = r && ut.isPlainObject(r) ? r : {}), (u[n] = ut.extend(l, o, i))) : i !== t && (u[n] = i));
            return u;
        }),
        ut.extend({
            ...
            parseJSON: function (n) {
                return e.JSON && e.JSON.parse
                    ...
                    : null === n
                    ? n
                    : "string" == typeof n && ((n = ut.trim(n)), n && pt.test(n.replace(vt, "@").replace(mt, "]").replace(dt, "")))
                    ? Function("return " + n)()
    ...
    (ut.Callbacks = function (e) {
        ...
        (ut.support = (function () {
            var n,
                ...
                c,
                h = $.createElement("div");
            if ((h.setAttribute("className", "t"), (h.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>"), (r = h.getElementsByTagName("*")), (i = h.getElementsByTagName("a")[0]), !r || !i || !r.length))
                return {};
            ...
            return (
                ...
                ut(function () {
                    ...
                    u &&
                        ...
                        e.getComputedStyle &&
                            ((n.pixelPosition = "1%" !== (e.getComputedStyle(h, null) || {}).top),
                            (n.boxSizingReliable =
                                "4px" ===
                                (
                ...
                return (
                    ...
                    this.each(function (r) {
                        ...
                        1 === this.nodeType &&
                            ...
                            (n = ut.valHooks[this.type] || ut.valHooks[this.nodeName.toLowerCase()]),
            ...
            attr: function (e, n, r) {
                ...
                if (e && 3 !== u && 8 !== u && 2 !== u)
                    return e.getAttribute === t
                        ? ut.prop(e, n, r)
                        : ((o = 1 !== u || !ut.isXMLDoc(e)),
                          o && ((n = n.toLowerCase()), (s = ut.attrHooks[n] || (Ot.test(n) ? Nt : Tt))),
                          r === t
    ...
    (ut.event = {
            ...
            if (g) {
                for (
                    ...
                    (a = Ft.exec(n[l]) || []),
                        ...
                        (p = f[d]) || ((p = f[d] = []), (p.delegateCount = 0), (h.setup && h.setup.call(e, i, v, u) !== !1) || (e.addEventListener ? e.addEventListener(d, u, !1) : e.attachEvent && e.attachEvent("on" + d, u))),
                        h.add && (h.add.call(e, c), c.handler.guid || (c.handler.guid = r.guid)),
        ...
        trigger: function (n, r, i, s) {
            ...
            if (
                ...
                3 !== i.nodeType &&
                    ...
                    (n.isTrigger = !0),
                    (n.namespace = v.join(".")),
                    (n.namespace_re = n.namespace ? RegExp("(^|\\.)" + v.join("\\.(?:.*\\.|)") + "(\\.|$)") : null),
                    (n.result = t),
                    n.target || (n.target = i),
                ...
                for (o = 0; (u = p[o++]) && !n.isPropagationStopped(); )
                    (n.type = o > 1 ? f : h.bindType || d),
                        (c = (ut._data(u, "events") || {})[n.type] && ut._data(u, "handle")),
                        c && c.apply(u, r),
                        (c = l && u[l]),
                        c && ut.acceptData(u) && c.apply && c.apply(u, r) === !1 && n.preventDefault();
                ...
                for (u = ut.event.handlers.call(this, e, f), n = 0; (s = u[n++]) && !e.isPropagationStopped(); )
                    for (e.currentTarget = s.elem, r = 0; (o = s.handlers[r++]) && !e.isImmediatePropagationStopped(); )
                        (!e.namespace_re || e.namespace_re.test(o.namespace)) &&
                            ((e.handleObj = o), (e.data = o.data), (i = ((ut.event.special[o.origType] || {}).handle || o.handler).apply(s.elem, a)), i !== t && (e.result = i) === !1 && (e.preventDefault(), e.stopPropagation()));
            ...
            (ut.event.special.submit = {
                setup: function () {
                    return ut.nodeName(this, "form")
                        ? !1
                        : (ut.event.add(this, "click._submit keypress._submit", function (e) {
                              var n = e.target,
        ...
        ut.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error contextmenu".split(" "), function (
            e,
            t
        ) {
        ...
        (function (e, t) {
            ...
            function c(e, t) {
                ...
                for (u = e, a = [], f = T.preFilter; u; ) {
                    (!n || (r = at.exec(u))) && (r && (u = u.slice(r[0].length) || u), a.push((i = []))),
                        (n = !1),
                        (r = ft.exec(u)) &&
                            ((n = r.shift()),
                            i.push({
            ...
            (C = o.isXML = function (e) {
                          ...
                          (R.qsa = n(r.querySelectorAll)) &&
                              (s(function (e) {
                                  (e.innerHTML = "<select><option selected=''></option></select>"),
                                      e.querySelectorAll("[selected]").length || P.push("\\[" + et + "*(?:checked|disabled|ismap|multiple|readonly|selected|value)"),
                                      e.querySelectorAll(":checked").length || P.push(":checked");
                              }),
                              s(function (e) {
                                  (e.innerHTML = "<input type='hidden' i=''/>"),
                                      e.querySelectorAll("[i^='']").length && P.push("[*^$]=" + et + "*(?:\"\"|'')"),
                                      e.querySelectorAll(":enabled").length || P.push(":enabled", ":disabled"),
                                      e.querySelectorAll("*,:x"),
                                      P.push(",.*:");
                              })),
                          (R.matchesSelector = n((B = _.matchesSelector || _.mozMatchesSelector || _.webkitMatchesSelector || _.oMatchesSelector || _.msMatchesSelector))) &&
                              s(function (e) {
                ...
                (o.matchesSelector = function (e, t) {
                    if (((e.ownerDocument || e) !== M && O(e), (t = t.replace(bt, "='$1']")), !(!R.matchesSelector || D || (H && H.test(t)) || P.test(t))))
                        try {
                            var n = B.call(e, t);
                ...
                (o.attr = function (e, t) {
                    ...
                    return (
                        ...
                        D || (t = t.toLowerCase()),
                        (n = T.attrHandle[t]) ? n(e) : D || R.attributes ? e.getAttribute(t) : ((n = e.getAttributeNode(t)) || e.getAttribute(t)) && e[t] === !0 ? t : n && n.specified ? n.value : null
                    );
                }),
                (o.error = function (e) {
                    ...
                    preFilter: {
                        ...
                        PSEUDO: function (e) {
                            ...
                            return ht.CHILD.test(e[0])
                                ? null
                                : (e[4] ? (e[2] = e[4]) : n && lt.test(n) && (t = c(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && ((e[0] = e[0].slice(0, t)), (e[2] = n.slice(0, t))), e.slice(0, 3));
                        },
                    },
                    filter: {
                        TAG: function (e) {
                            ...
                            return 1 === r && 0 === i
                                ...
                                : function (t, n, a) {
                                      ...
                                      if (m) {
                                          ...
                                          else for (; (c = (++p && c && c[v]) || (h = p = 0) || d.pop()) && ((u ? c.nodeName.toLowerCase() !== g : 1 !== c.nodeType) || !++h || (y && ((c[I] || (c[I] = {}))[e] = [U, h]), c !== t)); );
    ...
    (sn.optgroup = sn.option),
        ...
        ut.fn.extend({
            ...
            domManip: function (e, n, r) {
                ...
                var i,
                    ...
                    g = e[0],
                    y = ut.isFunction(g);
                if (y || (!(1 >= c || "string" != typeof g || ut.support.checkClone) && en.test(g)))
                ...
                if (c && ((i = ut.buildFragment(e, this[0].ownerDocument, !1, this)), (s = i.firstChild), 1 === i.childNodes.length && (i = s), s)) {
                    ...
                    if (u)
                        for (f = o[o.length - 1].ownerDocument, ut.map(o, v), l = 0; u > l; l++)
                            (a = o[l]),
                                tn.test(a.type || "") &&
        ...
        ut.extend({
            clone: function (e, t, n) {
                ...
                if (
                    (ut.support.html5Clone || ut.isXMLDoc(e) || !Vt.test("<" + e.nodeName + ">") ? (u = e.cloneNode(!0)) : ((un.innerHTML = e.outerHTML), un.removeChild((u = un.firstChild))),
                    !((ut.support.noCloneEvent && ut.support.noCloneChecked) || (1 !== e.nodeType && 11 !== e.nodeType) || ut.isXMLDoc(e)))
                )
                    for (r = b(u), i = b(e), o = 0; null != (s = i[o]); ++o) r[o] && y(s, r[o]);
                if (t)
                    if (n) for (i = i || b(e), r = r || b(u), o = 0; null != (s = i[o]); o++) g(s, r[o]);
                    else g(e, u);
            ...
            buildFragment: function (e, t, n, r) {
                    ...
                    if (((s = e[v]), s || 0 === s))
                        if ("object" === ut.type(s)) ut.merge(d, s.nodeType ? [s] : s);
                            ...
                            if ((!ut.support.leadingWhitespace && $t.test(s) && d.push(t.createTextNode($t.exec(s)[0])), !ut.support.tbody))
                                for (s = "table" !== o || Qt.test(s) ? ("<table>" !== a[1] || Qt.test(s) ? 0 : u) : u.firstChild, l = s && s.childNodes.length; l--; )
                ...
                for (u && p.removeChild(u), ut.support.appendChecked || ut.grep(b(d, "input"), w), v = 0; (s = d[v++]); )
                    if ((!r || -1 === ut.inArray(s, r)) && ((i = ut.contains(s.ownerDocument, s)), (u = b(p.appendChild(s), "script")), i && m(u), n)) for (l = 0; (s = u[l++]); ) tn.test(s.type || "") && n.push(s);
                return (u = null), p;
            },
        ...
        ut.extend({
            ...
            style: function (e, n, r, i) {
                if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                    ...
                    if (
                        ((o = typeof r),
                        "string" === o && (s = yn.exec(r)) && ((r = (s[1] + 1) * s[2] + parseFloat(ut.css(e, n))), (o = "number")),
                        !(
                            null == r ||
                            ("number" === o && isNaN(r)) ||
                            ("number" !== o || ut.cssNumber[a] || (r += "px"), ut.support.clearCloneStyle || "" !== r || 0 !== n.indexOf("background") || (f[n] = "inherit"), u && "set" in u && (r = u.set(e, r, i)) === t)
                        ))
                    )
                        try {
                            f[n] = r;
            ...
            css: function (e, n, r, i) {
                ...
                return (
                    ...
                    r ? ((o = parseFloat(s)), r === !0 || ut.isNumeric(o) ? o || 0 : s) : s
                );
            },
        ...
        e.getComputedStyle
            ? ((fn = function (t) {
              ...
              (an = function (e, n, r) {
                  ...
                  return (
                      u &&
                          ("" !== a || ut.contains(e.ownerDocument, e) || (a = ut.style(e, n)),
                          gn.test(a) && vn.test(n) && ((i = f.width), (s = f.minWidth), (o = f.maxWidth), (f.minWidth = f.maxWidth = f.width = a), (a = u.width), (f.width = i), (f.minWidth = s), (f.maxWidth = o))),
                      a
                  );
              }))
            : $.documentElement.currentStyle &&
              ...
              (an = function (e, n, r) {
                  ...
                  return (
                      ...
                      gn.test(a) &&
                          !pn.test(n) &&
                          ((i = f.left), (s = e.runtimeStyle), (o = s && s.left), o && (s.left = e.currentStyle.left), (f.left = "fontSize" === n ? "1em" : a), (a = f.pixelLeft + "px"), (f.left = i), o && (s.left = o)),
                      "" === a ? "auto" : a
                  );
              })),
    ...
    ut.fn.extend({
        ...
        (ut.param = function (e, n) {
            ...
            if ((n === t && (n = ut.ajaxSettings && ut.ajaxSettings.traditional), ut.isArray(e) || (e.jquery && !ut.isPlainObject(e))))
                ut.each(e, function () {
    ...
    (An = In.exec(On.toLowerCase()) || []),
        (ut.fn.load = function (e, n, r) {
            ...
            return (
                ...
                ut.isFunction(n) ? ((r = n), (n = t)) : n && "object" == typeof n && (s = "POST"),
                u.length > 0 &&
                    ut
                        .ajax({
                            url: e,
            ...
            ajax: function (e, n) {
                function r(e, n, r, u) {
                    ...
                    2 !== w &&
                        ...
                        r && (b = D(h, S, r)),
                        (e >= 200 && 300 > e) || 304 === e
                            ? (h.ifModified && ((E = S.getResponseHeader("Last-Modified")), E && (ut.lastModified[s] = E), (E = S.getResponseHeader("etag")), E && (ut.etag[s] = E)),
                              304 === e ? ((f = !0), (x = "notmodified")) : ((f = P(h, b)), (x = f.state), (c = f.data), (y = f.error), (f = !y)))
                        ...
                        m.fireWith(p, [S, x]),
                        l && (d.trigger("ajaxComplete", [S, h]), --ut.active || ut.event.trigger("ajaxStop")));
                }
                ...
                if (
                    ...
                    (S.success = S.done),
                    (S.error = S.fail),
                    (h.url = ((e || h.url || On) + "").replace(Dn, "").replace(Fn, An[1] + "//")),
                    (h.type = n.method || n.type || h.method || h.type),
                    (h.dataTypes = ut
                        .trim(h.dataType || "*")
                        .toLowerCase()
                        .match(ft) || [""]),
                    null == h.crossDomain && ((f = In.exec(h.url.toLowerCase())), (h.crossDomain = !(!f || (f[1] === An[1] && f[2] === An[2] && (f[3] || ("http:" === f[1] ? 80 : 443)) == (An[3] || ("http:" === An[1] ? 80 : 443)))))),
                ...
                (l = h.global),
                    ...
                    (s = h.url),
                    h.hasContent || (h.data && ((s = h.url += (_n.test(s) ? "&" : "?") + h.data), delete h.data), h.cache === !1 && (h.url = Pn.test(s) ? s.replace(Pn, "$1_=" + Mn++) : s + (_n.test(s) ? "&" : "?") + "_=" + Mn++)),
                    h.ifModified && (ut.lastModified[s] && S.setRequestHeader("If-Modified-Since", ut.lastModified[s]), ut.etag[s] && S.setRequestHeader("If-None-Match", ut.etag[s])),
                    ((h.data && h.hasContent && h.contentType !== !1) || n.contentType) && S.setRequestHeader("Content-Type", h.contentType),
                    S.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + zn + "; q=0.01" : "") : h.accepts["*"]);
    ...
    ut.ajaxSetup({
        ...
        ut.ajaxPrefilter("json jsonp", function (n, r, i) {
            ...
            return a || "jsonp" === n.dataTypes[0]
                ? ((s = n.jsonpCallback = ut.isFunction(n.jsonpCallback) ? n.jsonpCallback() : n.jsonpCallback),
                  a ? (n[a] = n[a].replace(Vn, "$1" + s)) : n.jsonp !== !1 && (n.url += (_n.test(n.url) ? "&" : "?") + n.jsonp + "=" + s),
    ...
    (ut.Animation = ut.extend(I, {
        ...
        (U.prototype = {
            ...
            run: function (e) {
                ...
                return (
                    (this.pos = t = this.options.duration ? ut.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration) : e),
        ...
        (ut.speed = function (e, t, n) {
            ...
            return (
                (r.duration = ut.fx.off ? 0 : "number" == typeof r.duration ? r.duration : r.duration in ut.fx.speeds ? ut.fx.speeds[r.duration] : ut.fx.speeds._default),
                ...
                if (this[0]) {
                    ...
                    return (
                        "fixed" === ut.css(r, "position")
                            ...
                            : ((e = this.offsetParent()), (t = this.offset()), ut.nodeName(e[0], "html") || (n = e.offset()), (n.top += ut.css(e[0], "borderTopWidth", !0)), (n.left += ut.css(e[0], "borderLeftWidth", !0))),
                        {
    ...
    function () {
        ...
        (m.started = !1),
            s.extend(m.prototype, a, {
                ...
                start: function (e) {
                    ...
                    r && ((this.iframe = o('<iframe src="javascript:0" tabindex="-1" />').hide().appendTo("body")[0].contentWindow), this.navigate(t)),
                        this._hasPushState
                    ...
                    this._wantsPushState &&
                        ...
                        u &&
                        i.hash &&
                        ((this.fragment = this.getHash().replace(g, "")), window.history.replaceState({}, document.title, i.protocol + "//" + i.host + this.options.root + this.fragment));
                ...
                navigate: function (e, t) {
                    ...
                    this._hasPushState
                        ? (n.indexOf(this.options.root) != 0 && (n = this.options.root + n), (this.fragment = n), window.history[t.replace ? "replaceState" : "pushState"]({}, document.title, n))
                        : this._wantsHashChange
                        ? ((this.fragment = n),
                          this._updateHash(window.location, n, t.replace),
                          this.iframe && n != this.getFragment(this.getHash(this.iframe)) && (t.replace || this.iframe.document.open().close(), this._updateHash(this.iframe.location, n, t.replace)))
        ...
        (i.sync = function (e, t, n) {
            ...
            return (
                ...
                !n.data && t && (e == "create" || e == "update") && ((u.contentType = "application/json"), (u.data = JSON.stringify(t.toJSON()))),
                i.emulateJSON &&
    ...
    define("models/snippet", ["jquery", "underscore", "backbone"], function (e, t, n) {
    ...
    define("text", ["module"], function (e) {
        ...
        t = {
            ...
            parseName: function (e) {
                ...
                return (
                    s !== -1 && (!o || s > 1) ? ((t = e.substring(0, s)), (n = e.substring(s + 1, e.length))) : (t = e),
                    (r = n || t),
                    (s = r.indexOf("!")),
    ...
    define("templates/snippet/snippet-templates", [
        "require",
...
+(function (e) {
    ...
    +(function (e) {
        ...
        (t.DEFAULTS = {
            ...
            (t.prototype.pause = function (t) {
                return (
                    t || (this.paused = !0), this.$element.find(".next, .prev").length && e.support.transition.end && (this.$element.trigger(e.support.transition.end), this.cycle(!0)), (this.interval = clearInterval(this.interval)), this
                );
            }),
    ...
    +(function (e) {
        ...
        (e.fn.dropdown = function (t) {
            ...
            e(document)
                ...
                .on("keydown.bs.dropdown.data-api", n + ", [role=menu]", r.prototype.keydown);
    })(window.jQuery),
    +(function (e) {
        var t = function (t, n) {
        ...
        (t.DEFAULTS = e.extend({}, e.fn.tooltip.Constructor.DEFAULTS, {
            ...
            (t.prototype.setContent = function () {
                ...
                e.find(".popover-header")[this.options.html ? "html" : "text"](t),
                    ...
                    e.removeClass("fade bs-popover-top bs-popover-bottom bs-popover-left bs-popover-right show"),
    ...
    define("views/my-form", ["jquery", "underscore", "backbone", "views/temp-snippet", "helper/pubsub", "text!templates/app/renderform.html", "Guid"], function (e, t, n, r, i, s) {
        return n.View.extend({
            tagName: "fieldset",
            initialize: function () {
            ...
            handleTempMove: function (t) {
                e(".target").removeClass("target"),
                    t.pageX >= this.buildBCR.left && t.pageX < this.$build.width() + this.buildBCR.left && t.pageY >= this.buildBCR.top && t.pageY < this.$build.height() + this.buildBCR.top
        ...
        return {
            initialize: function () {
                new s({
                    ...
                    new s({
                        title: "Radios / Checkboxes (چک باکس)",
                        collection: new r(JSON.parse(a)),
                    }),
                    new s({
                        title: "Select (انتخابگر)",
                        collection: new r(JSON.parse(f)),
                    }),
                    new s({
                        title: "Buttons (دکمه ها)",
                    ...
                    e("#formtabs li a").addClass("nav-link m-r-5").first().addClass("active"),
                    new o({
                        title: "Original",
                        collection: new i([
                            {
